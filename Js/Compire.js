...
function jacobiMethod(matrix, n, iterations) {
    const stepDiv = document.getElementById("innerStep2");
    
    stepDiv.innerHTML = ""; // Clear previous content
    innerStep2.style.display = "block";
    solutionHead2.style.display = "block";
  ...
  function gaussianElimination(matrix, n) {
    const stepDiv = document.getElementById("innerStep1");
    stepDiv.innerHTML = ""; // Clear the content before starting
    innerStep1.style.display = "block";
    solutionHead1.style.display = "block";
    let stage = "a";
    for (let i = 0; i < n; i++) {
  ...
  function solve() {
    ...
    const solutionsDiv = document.getElementById("solutions1");
    ...
    console.log(augmentedMatrix);
    augmentedMatrix = [];
    jacobiMethod(augmentedMatrix, n, 10);
    const solutionsDiv2 = document.getElementById("solutions2");
    solutionsDiv2.innerHTML = "Final Solutions: <br>";
    for (let i = 0; i < n; i++) {
      solutionsDiv2.innerHTML += `x${i + 1} = ${augmentedMatrix[i][n].toFixed(
        4
      )}<br>`;
    }
    console.log(augmentedMatrix);
